export const home = {
  ...
  whyCompare: {
    usual: {
      label: "Обичайният начин",
      points: [
        "Плащате аванс, преди да видите нещо",
        "Разбирате какво получавате чак накрая",
        "Обещания вместо доказателства",
        "Скрити такси и неясен обхват",
      ],
    },
    dm: {
      label: "Начинът на D&M",
      points: [
        "Първо изграждаме безплатно демо",
        "Виждате реалния дизайн, преди да платите",
        "Доказателство, не обещания",
        "Прозрачен обхват и честна цена",
      ],
    },
  },
  featuredWork: {
